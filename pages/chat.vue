  ...
  <div>
    ...
    <div class="container px-0 mt-5">
        <div id="chat-container" style="min-height:400px; max-height:400px; height:400px;" class="overflow-auto">
            ...
            >
                ...
                >
                    ...
                    <p
                        class="py-0 text-super-light small"
                    ...
                    <button class="btn rounded btn-secondary shadow">N</button>
                    </div>
                </div>
                </div>
            </div>
      ...
      <div class="row mx-0 my-4">
        ...
        <div class="col-md-12 px-0 my-4 text-right">
          <button
            @click="sendMsg()"
            :disabled="!text"
            class="btn btn-primary border-radius px-5 py-3"
          >
            Send
          </button>
        </div>
